...
object TweetToMySQL extends Serializable {
  ...
  // load data
  ELTComponents.Load.toMysql(transformedSource, mySQLProperties("url"), mySQLProperties("database"), mySQLProperties("table_tweet"),
